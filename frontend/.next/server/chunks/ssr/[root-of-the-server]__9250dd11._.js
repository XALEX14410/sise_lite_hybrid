...
function HomePage() {
    ...
    const loadUsuarios = async ()=>{
        try {
            const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getUsuarios"])();
            setRows(data);
        } catch (err) {
            console.error(err);
        }
    ...
    const seed = async ()=>{
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createUsuario"])({
            id: Date.now(),
            name: "Nuevo Usuario",
    ...
    const remove = async (id)=>{
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["deleteUsuario"])(id);
        loadUsuarios();
    };
    // Filtrado
...
//# sourceMappingURL=%5Broot-of-the-server%5D__9250dd11._.js.map